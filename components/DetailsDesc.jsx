  ...
  return (
    <>
      ...
      <View style={{ marginVertical: SIZES.extraLarge * 1.5 }}>
          ...
          <View style={{ fontSize: SIZES.small, fontFamily: FONTS.semiBold, color: COLORS.primary }}>
              <Text style={{ fontSize: SIZES.small, fontFamily: FONTS.regular, color: COLORS.secondary, lineHeight: SIZES.large }}>
                  {text}
                  {!readMore && '...'}
                  <Text style={{ fontSize: SIZES.small, fontFamily: FONTS.semiBold, color: COLORS.primary }} onPress={() => { if (!readMore) {
